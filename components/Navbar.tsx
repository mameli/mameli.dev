          ...
          <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:block sm:ml-auto items-center">
                  <div className="flex space-x-4 items-center">
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          ...
                          'px-3 py-10 rounded-md text-lg font-medium'
                        )}
                    ...
                    <button
                      aria-label="Toggle Dark Mode"
                      type="button"
                      className="w-10 h-10 rounded-lg flex items-center justify-center  hover:ring-2 ring-gray-900 dark:ring-gray-300  transition-all"
                      onClick={() =>
          ...
          <Disclosure.Panel className="sm:hidden">
                ...
                <Disclosure.Button
                  ...
                  className={classNames(
                    item.current
                      ? 'bg-gray-900 text-white'
                      : 'dark:text-gray-300 hover:bg-gray-700 hover:text-white',
                    'block px-3 py-2 rounded-md text-lg font-medium dark:text-white text-right'
                  )}
                  aria-current={item.current ? 'page' : undefined}
                >
                  {item.name}
            ...
            <div className="px-2">
              <button
                aria-label="Toggle Dark Mode"
                type="button"
                className="mx-1 py-2 w-10 h-10 rounded-lg flex items-center justify-center  hover:ring-2 ring-gray-900  dark:ring-gray-300 transition-all ml-auto"
                onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
              >
                {mounted && (
                  <svg
