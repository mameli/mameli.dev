...
\begin{onecolentry}
Experienced \textbf{Data Engineer} with a Master's Degree in Data Science, focused on cloud data platforms, Databricks, and pragmatic data architecture. Skilled in building production data pipelines, simplifying complex architectures, and driving delivery across unclear requirements, vendors, and stakeholder constraints.
\end{onecolentry}
...
\begin{onecolentry}
    \begin{highlights}
        \item Industrialized Python code developed by data scientists into production \textbf{MLOps} pipelines on \textbf{AWS}, integrating Lambda, SageMaker Pipelines, S3, DynamoDB, EventBridge, Terraform, and Jenkins.
        \item Reworked a complex cross-cloud data-transfer architecture toward a simpler \textbf{Azure Function} and \textbf{ADF} push-based flow into S3, reducing operational complexity and cost.
        \item Built monitoring for production ML pipelines by integrating \textbf{AWS CloudWatch} metrics with \textbf{Datadog}, improving visibility into production environments where direct AWS access was restricted.
        \item \textbf{Active contributor} to internal training and knowledge-sharing initiatives on modern Python tooling, Spark, LLM workflows, and practical data-engineering practices.
...
\begin{onecolentry}
    \textbf{Programming:} Python, SQL, Scala/Java, Bash/Zsh, JavaScript/TypeScript
\end{onecolentry}

\vspace{0.2 cm}

\begin{onecolentry}
    \textbf{Data Platforms:} Databricks, Spark, Snowflake, dbt, Kafka, Delta Lake, SQL Server
\end{onecolentry}

\vspace{0.2 cm}

\begin{onecolentry}
    \textbf{Cloud \& DevOps:} AWS, Azure, Terraform, Docker, Kubernetes/OpenShift, GitHub Actions, Jenkins
\end{onecolentry}

\vspace{0.2 cm}

\begin{onecolentry}
    \textbf{AI/Machine Learning:} MLflow, PyTorch, Scikit-learn, Hugging Face, Bedrock, SageMaker
\end{onecolentry}

% Old skills kept for check:
